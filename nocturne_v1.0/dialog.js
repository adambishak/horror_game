...
function displayWinningScreen() {
  background(0); // Aesthetics can be altered later
  image(flower, width / 2 - 50, height / 2 + 80, 100, 130);
  fill(255);
  textSize(32);
  textAlign(CENTER, CENTER);
  ...
  textSize(20);
  text("Press any key restart", width / 2, height / 2 + 50);
  text("Embrace the shadows, but remember, you hold the brush to paint your own sunrise against the canvas of depression.", width / 2, height / 2);
}